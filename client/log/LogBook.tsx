...
//           if (prevY !== y) {
//             // **Draw a vertical line to switch rows**
//             ctx.lineTo(prevX, y);
//           }

//           // **Draw a horizontal line for the current duty**
//           ctx.lineTo(x, y);
//         }
//       });
...
//     drawGrid();
//     drawLogbook();
//   }, [logbook]); // Depend on `logbook` so it updates only when needed

//   return (
//     <div className="w-full flex flex-row justify-center items-center overflow-x-auto p-5 bg-[#f5f5f5] border-solid border-2 border-black">
...
//         <div className="w-[30px] h-[30px] bg-[#FFD700] border-b-[1px]"></div>
//         <div className="w-[30px] h-[30px] bg-[#87CEEB] border-b-[1px]"></div>
//         <div className="w-[30px] h-[30px] bg-[#90EE90] border-b-[1px]"></div>
//         <div className="w-[30px] h-[30px] bg-[#FFB6C1]"></div>
//       </div>
//     </div>
//   );
// };
  ...
  return (
    <div className="w-full flex flex-col gap-8 p-5 bg-[#f5f5f5] border-solid border-2 border-black">
      {logbooks.map((logbook, index) => (
        <SingleLogbook key={index} logbook={logbook.logbook} gridSize={gridSize} day={index + 1} />
      ))}
    </div>
  );
};
...
const SingleLogbook: React.FC<LogbookProps> = ({ logbook, gridSize, day }) => {
  const canvasRef = useRef<HTMLCanvasElement>(null);
